<?php
    ...
    if(isset($_POST['btn'])) {
        ...
        if($data) {
            ...
            header('Location: success.php'); // redirect to success.html
...
<body>
    ...
    <div class="getintouch">
        <h1 class="titre1">Get in Touch</h1>
        <p id="phrase" >Feel free to drop us a line below!</p>
        <form method="post" action="" class="formul">
            <input type="text" placeholder=" First name"  id="move" name="firstname" required> <br> <br> <br>
            <input type="text" placeholder=" Last name"  id="move" name="lastname" required> <br> <br> <br>
            <input type="email" placeholder=" Your Email" id="move" name="email"> <br> <br> <br>
            <textarea id="mytext" rows="5" cols="45"  placeholder="Typing your message here..." name="msg">
            </textarea>
            <p class="newto"> </p>
            <button class="btn" type="submit" name="btn">SEND</button> 
        </form>
    </div>
    <div class="contact"> 
        <h1 class="contacttitle">Contact Us</h1>
        <ul id="hi">
        <li id="none"> <a href="https://www.google.com/maps/search/?api=1&query=410%20Napa%20Junction%20Rd%2C%20Suite%20100%2C%20American%20Canyon%2C%20CA%2094503%20US&output=classic&query_place_id=ChIJ87LgYA0MhYARljhzl8_lXZQ"><img src="./images/map.png" width="20" id="im"> Donuts America</li></a> <br> <br> <br>
        <li id="none"><img src="./images/phone-call.png" width="20" id="im"> 1-800-447-0013</li> <br> <br> <br>
        <li id="none">  <a href="mailto: dunkin'@gmail.com">  <img src="./images/email.png" width="20" id="im"> Dunkin'@gmail.com</li> </a> <br> <br> <br>
    </ul>
